...
Creating a field of menger cubes works like so:
    - create a field of cubes in the X and Z direction
   	 - get the object-space bounding box and use that as a step
   	   (so that no cube intersect another) + user defined spacing
   	 ...
   	 - randomize the values of the attributes,
   	   within given user constraints
    - get the current scene name, move up to the project directory and
      navigate to the data folder and place files there
   	 - the file name is automatically generated using the scene
   	   name, the full dag path of the given
...
Code Links
==============================================================================
A full zip file, containing all of the required files is `menger zip file`_
