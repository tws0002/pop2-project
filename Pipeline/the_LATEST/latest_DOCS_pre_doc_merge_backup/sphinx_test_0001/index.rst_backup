...
.. _`bug_report_page`: https://docs.google.com/spreadsheets/d/1PC98Qsx79s4hxRaap3m9U0cKT1TLpHDCvMtDsZAQ6ZA/edit

.. Reference here https://stackoverflow.com/questions/19686897

|project_long_name| Documentation
====================================================
.. image:: img/banner-original_cropped.jpg
   :align:   center
...
There are two main portals for the project, one for uses and the other for
admins.
