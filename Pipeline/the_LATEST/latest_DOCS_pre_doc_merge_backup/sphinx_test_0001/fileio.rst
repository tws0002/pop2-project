...
****************************
All of the methods for determining read/write permission, constructing and modifying paths, directory listings, and any general file-level operations are contained within this package. A great deal of the entire environment is contained within these modules and are referenced in nearly every tool used. Be VERY cautious before editing.
