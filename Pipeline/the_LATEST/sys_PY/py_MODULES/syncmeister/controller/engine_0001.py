...
def get_lines_from_quoted_string(dataH):
    """
...
def replace_lines_from_dict(dictH, dataH):
...
def test_line_mod():
    ...
    with open(fileLocation, "r") as f:
        data = f.readlines()
    lines = get_lines_from_quoted_string(data)
    return replace_lines_from_dict(lines, data)
# ened test_line_mod
