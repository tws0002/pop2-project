...
# from licensechooser import licensechooser
...
FORMCLASS = uic.loadUiType(CURRENTDIR + os.sep + "maingui_0001.ui")[0]


class Window(QtGui.QMainWindow, FORMCLASS):
    """
    The module that will be used to extend the FORMCLASS (the software backup layout)
    """
