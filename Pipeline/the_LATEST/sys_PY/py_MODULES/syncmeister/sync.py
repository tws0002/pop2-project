...
import controller.pathfinder as pathfinder
...
class UIExtension(QtGui.QMainWindow, maingui.Ui_MainWindow):
    """
    ...
    """
    defaultRootDirText = "{ project path here without the {}s }"
    ...
    def __init__(self, parent=None):
        ...
        self.root_path_le.setText(self.defaultRootDirText)
