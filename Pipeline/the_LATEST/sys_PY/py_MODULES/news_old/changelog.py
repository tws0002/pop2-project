...
FORMCLASS_WINDOW = uic.loadUiType(os.path.join(CURRENTDIR, 'view',
                                               "changeLogBase.ui"))[0]
FORMCLASS_OK_WINDOW = uic.loadUiType(os.path.join(CURRENTDIR, "view",
                                                  "changeLogOK.ui"))[0]
...
class Window(QtGui.QMainWindow, FORMCLASS_WINDOW):
    """ Main window"""
    def __init__(self, applicationType, parent=None):
        """
...
class OKWindow(QtGui.QDialog, FORMCLASS_OK_WINDOW):
    """
