...
SHOT_MATCH_PATTERN = r"""
                      ^((_+)?s0(?P<shot>\d{2})(?P<shotRevision>[A-Z]{1,2})?
                      (_v(?P<shotRedraft>\d+)_|_)?)?
                      """
MATCH_RE = SHOT_MATCH_PATTERN + \
            r'''
             (?P<user>[\x00-\x7F]{4,8}(\d{2})?)_
             (?P<version>0\d{2})(?P<versionRevision>[A-Z])?_
             (?P<type>[A-Z]{3,5})
             (_(?P<description>[a-zA-Z]+)?)?
             ((_v|.)(?P<increment>(0\d{3}|\#+|\$F\d+|\%0\d+d))(?P<incrementRevision>[A-Z])?).
             ''' + _EXT
...
MATCH_RE = SHOT_MATCH_PATTERN + \
            r'''
             (?P<user>[\x00-\x7F]{4,8}(\d{2})?)(?P<userSuffix>_)
...
str1 = "s001_ckenne24_010_MODEL_asdfasdfasdf.0001.ma"
reMatch = re.match(RE_FILENAME_MATCH, str1)

terms = ["filenamePrefix", "shotPrefix", "shot", "shotRevision",
         "shotRedraftWrapper", "user", "userSuffix", "version",
         "versionRevision", "versionSuffix", "type", "descriptionPrefix",
         "description", "incrementPrefix", "increment", "incrementRevision",
         "incrementSuffix", "extension"]
for term in terms:
    print reMatch.group(term)

filenameTest = ""
for term in terms:
    if reMatch.group(term) is not None:
        filenameTest += reMatch.group(term)
print ''.join(filenameTest)
print str1
# str1 = r"s001"
# reMatch = re.match(RE_FILENAME_MATCH, "s013C_ckenne24_010_PLTFG_asfadsf.%04d.exr")
# str2 = r"s001A"
# str3 = r"s001AF"
# str4 = r"s001AF_v4"
# _test = re.compile(SHOT_MATCH_PATTERN, re.VERBOSE)
# _sceneList = [str1, str2, str3, str4]
# for x in _sceneList:
#     match = re.match(_test, x)
#     print '"' + match.group() + '"'
# str5 = r"ckenne24_010_MODEL_ASDASDADS_v0001.nk"
# str1 = r"s001_ckenne24_010_MODEL_ASDASDADS_v0001.nk"
# str2 = r"s001A_ckenne24_010_MODEL_ASDASDADS_v0001.nk"
# str3 = r"s001AF_ckenne24_010_MODEL_ASDASDADS_v0001.nk"
# str4 = r"s001AF_v4_ckenne24_010_MODEL_ASDASDADS_v0001.nk"
#
# str5 = r"s001_ckenne24_010_MODEL_ASDASDADS_v0001.nk"
# str1 = r"s001_jpasqual_010_MODEL_ASDASDADS_v0001.nk"
# str2 = r"s001_jpasqual_010_MODEL_ASDASDADS_v0001.nk"
# str3 = r"s001_jpasqual_010_MODEL_ASDASDADS_v0001.nk"
# str4 = r"s001_v4_jpasqual_010_MODEL_ASDASDADS_v0001.nk"
# _sceneList = [str5, str1, str2, str3, str4]
# for x in _sceneList:
#     match = re.match(RE_FILENAME_MATCH, x)
#     print match.group()
