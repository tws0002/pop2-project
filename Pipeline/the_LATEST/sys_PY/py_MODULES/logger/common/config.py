...
if sys.platform == 'win32':
    USER_CONFIG_DIR = os.path.join(os.path.expandvars("$APPDATA"), "portal_origins_part_2")
    ...
    USER_CONFIG_DIR = os.path.join(HOME_DIR, ".config", "portal_origins_part_2")  # OpenDesktop standard
    if platform == "maemo":
...
CONFIG_FILE = "portal_origins_part_2.conf"
...
STYLESHEET_FILE = "portal_origins_part_2.css"
...
LOGGER_FILENAME = "portal_origins_part_2.log"
