...
# Form implementation generated from reading ui file '/home/selecaotwo/Dropbox/Private/my_PROJECT/proj_POP2/Pipeline/the_LATEST/sys_PY/py_MODULES/syncmeister/view/maingui_0001.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.skipPathConfirmation_cb = QtGui.QCheckBox(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.skipPathConfirmation_cb.sizePolicy().hasHeightForWidth())
        self.skipPathConfirmation_cb.setSizePolicy(sizePolicy)
        self.skipPathConfirmation_cb.setMinimumSize(QtCore.QSize(300, 0))
        self.skipPathConfirmation_cb.setChecked(True)
        self.skipPathConfirmation_cb.setObjectName(_fromUtf8("skipPathConfirmation_cb"))
        self.horizontalLayout_5.addWidget(self.skipPathConfirmation_cb)
        self.skipUnknownRelPaths_cb = QtGui.QCheckBox(self.centralwidget)
        self.skipUnknownRelPaths_cb.setChecked(False)
        self.skipUnknownRelPaths_cb.setObjectName(_fromUtf8("skipUnknownRelPaths_cb"))
        self.horizontalLayout_5.addWidget(self.skipUnknownRelPaths_cb)
        ...
        self.horizontalLayout_4.addWidget(self.seekPath_cb)
        ...
        self.horizontalLayout_4.addWidget(self.checkExists_cb)
        self.gridLayout.addLayout(self.horizontalLayout_4, 5, 0, 1, 2)
        self.horizontalLayout_3 = QtGui.QHBoxLayout()
        self.horizontalLayout_3.setObjectName(_fromUtf8("horizontalLayout_3"))
        self.pathSep_le = QtGui.QLineEdit(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pathSep_le.sizePolicy().hasHeightForWidth())
        self.pathSep_le.setSizePolicy(sizePolicy)
        self.pathSep_le.setMinimumSize(QtCore.QSize(30, 0))
        self.pathSep_le.setAlignment(QtCore.Qt.AlignCenter)
        self.pathSep_le.setObjectName(_fromUtf8("pathSep_le"))
        self.horizontalLayout_3.addWidget(self.pathSep_le)
        self.pathSep_l = QtGui.QLabel(self.centralwidget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pathSep_l.sizePolicy().hasHeightForWidth())
        self.pathSep_l.setSizePolicy(sizePolicy)
        self.pathSep_l.setMinimumSize(QtCore.QSize(20, 0))
        self.pathSep_l.setObjectName(_fromUtf8("pathSep_l"))
        self.horizontalLayout_3.addWidget(self.pathSep_l)
        ...
        self.horizontalLayout.addWidget(self.recursive_cb)
        ...
        self.horizontalLayout.addWidget(self.searchForMayaFiles_cb)
        ...
        spacerItem2 = QtGui.QSpacerItem(17, 13, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.skipPathConfirmation_cb.setToolTip(_translate("MainWindow", "<html><head/><body><p>(Optional) If a path is identified as being UNIX-based on a Windows machine, the script will stop and ask the user if it should process the string.</p></body></html>", None))
        self.skipPathConfirmation_cb.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>When differing OSes touch the same source file, their absolute paths are stored in their native format. This can cause errors if the path being resolved is from another OS. If you want greater control over what is processed and what isn\'t, disable this option.</p></body></html>", None))
        self.skipPathConfirmation_cb.setText(_translate("MainWindow", "Skip differing OS paths confirmation", None))
        self.skipUnknownRelPaths_cb.setToolTip(_translate("MainWindow", "<html><head/><body><p>(Optional) Enable only if your executions are running slowly or producing poor results.</p></body></html>", None))
        self.skipUnknownRelPaths_cb.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>To some degree, strings can be &quot;proven&quot; to be absolute or relative paths without necessarily knowing if the path exists. Strings that cannot be proven can still be processed however. <br/><br/>There\'s a chance that an unknown string can be found to be relative. In which case, it can be processed. But not allowing this option can slow down scripts considerably so keep that in mind.</p></body></html>", None))
        self.skipUnknownRelPaths_cb.setText(_translate("MainWindow", "Skip unknown relative paths", None))
        ...
        self.pathSep_le.setText(_translate("MainWindow", "/", None))
        self.pathSep_l.setToolTip(_translate("MainWindow", "<html><head/><body><p>(Optional) Doesn\'t require anything as input but a \'/\' is the recommended practice.</p></body></html>", None))
        self.pathSep_l.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Sometimes paths in Maya mix separators like /, //, \\\\, and \\ together in the same path. This cleans up the path to a single type</p></body></html>", None))
        self.pathSep_l.setText(_translate("MainWindow", "Replace Separators", None))
        ...
        self.recursive_cb.setText(_translate("MainWindow", "Search files/folders for Maya files Recursively", None))
        ...
        self.searchForMayaFiles_cb.setText(_translate("MainWindow", "Search within Maya files recursively for Maya files", None))
