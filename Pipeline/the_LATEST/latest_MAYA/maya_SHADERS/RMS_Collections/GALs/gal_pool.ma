...
//Name: gal_ocean.ma
//Last modified: Wed, Nov 13, 2013 03:26:19 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -n "GAL_Softbox";
...
createNode RMSGeoAreaLight -n "GAL_SoftboxShape" -p "GAL_Softbox";
	addAttr -ci true -sn "nts" -ln "notes" -dt "string";
	setAttr -k off ".v";
	setAttr ".ShadingRate" 1;
	setAttr ".rman__LightPrimaryVisibility" yes;
	setAttr ".intensity" 5;
	setAttr ".lightcolor" -type "float3" 0.30610839 0.86928654 0.93239963 ;
	setAttr ".temperature" 7500;
	setAttr ".distributionAngle" 1;
...
select -ne :defaultHardwareRenderGlobals;
	...
	setAttr -av -cb on ".gh";
	setAttr -cb on ".sd";
connectAttr "softbox.di" "GAL_Softbox.do";
connectAttr ":defaultRenderGlobals.msg" "mtorPartition.rgcnx";
connectAttr "GAL_SoftboxShape.ltd" ":lightList1.l" -na;
connectAttr "GAL_Softbox.iog" ":defaultLightSet.dsm" -na;
// End of gal_ocean.ma
