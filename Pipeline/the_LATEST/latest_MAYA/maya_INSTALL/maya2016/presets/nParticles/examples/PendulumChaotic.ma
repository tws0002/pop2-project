...
//Name: pendulumChaotic.ma
//Last modified: Tue, Apr 15, 2008 05:08:51 PM
//Codeset: 1252
...
fileInfo "cutIdentifier" "200804081957-000000";
fileInfo "osv" "Microsoft Windows XP x64 Service Pack 1 (Build 3790)\n";
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.046133013215127 1.576733808120657 8.9784186813464153 ;
	setAttr ".r" -type "double3" -9.3383527296022795 24.200000000000852 -1.3076216436866291e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.430282237198769;
...
createNode nParticle -n "nParticleShape1" -p "nParticle1";
	...
	setAttr ".pos0" -type "vectorArray" 3 0.0018559821182861924 -1.7361111531499773e-005
		 0.019634239375591278 0.85449337959289551 -1.7361111531499773e-005 0.012390420772135258 2.7043521404266357
		 -1.7361111531499773e-005 0.01590767502784729 ;
	setAttr ".vel0" -type "vectorArray" 3 0 -8.7311491370201111e-010 0 -2.86102294921875e-005
		 -8.7311491370201111e-010 0 -0.0002288818359375 -8.7311491370201111e-010 0 ;
	...
	setAttr ".nid" 3;
	setAttr ".nid0" 3;
	setAttr ".bt0" -type "doubleArray" 3 -21.75 -21.75 -21.75 ;
	setAttr ".ag0" -type "doubleArray" 3 32.75 32.75 32.75 ;
	...
	setAttr -s 3 ".rdc[0:2]"  0.070866145 0.57999998 0 0.33070865 
		1 1 0 0.56 0;
	setAttr ".rci" 5;
	setAttr ".rcix" 0.039999999105930328;
	setAttr -s 2 ".mssc[0:1]"  0 0 1 1 1 1;
	setAttr ".msli" 7;
	setAttr ".opc[0]"  0 1 1;
	setAttr ".oci" 1;
	setAttr -s 2 ".cl";
	setAttr ".cl[0].clp" 0.25196850299835205;
	setAttr ".cl[0].clc" -type "float3" 1.5 1.0367501 0 ;
	setAttr ".cl[0].cli" 1;
	setAttr ".cl[1].clp" 0.78740155696868896;
	setAttr ".cl[1].clc" -type "float3" 1 0 0.058333397 ;
	setAttr ".cl[1].cli" 1;
	setAttr ".coi" 6;
	setAttr ".inca[0].incap" 0;
	setAttr ".inca[0].incac" -type "float3" 0 0 0 ;
	setAttr ".inca[0].incai" 1;
	setAttr ".rgbPP0" -type "vectorArray" 3 0.26017475128173828 0.36991262435913086
		 0.73982524871826172 0.53617322444915771 0.23191340267658234 0.46382680535316467 0.73030275106430054
		 0.13484862446784973 0.26969724893569946 ;
	setAttr ".opacityPP0" -type "doubleArray" 3 1 1 1 ;
	setAttr ".radiusPP0" -type "doubleArray" 3 0.40000000596046448 0.40000000596046448
		 0.40000000596046448 ;
	setAttr ".lifespanPP0" -type "doubleArray" 3 3.4028234663852886e+038 3.4028234663852886e+038
		 3.4028234663852886e+038 ;
	setAttr -k on ".lifespan" 1;
createNode transform -n "dynamicConstraint1";
	setAttr ".t" -type "double3" 0.0018559821182861924 0 0.019634239375591278 ;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 0.0012685730981236709 0 -0.61032168901584838 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".s" -type "double3" 6.9139479115566296 6.9139479115566296 6.9139479115566296 ;
...
createNode nComponent -n "nComponent2";
	setAttr ".ct" 2;
	setAttr ".el" 2;
createNode animCurveTU -n "nucleus1_gravity";
	setAttr ".tan" 10;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 45 30 8;
...
createNode nComponent -n "nComponent5";
	setAttr ".ct" 2;
	setAttr ".el" 2;
	setAttr -s 3 ".ci[0:2]"  0 1 2;
createNode checker -n "checker1";
	addAttr -ci true -sn "resolution" -ln "resolution" -dv 32 -at "long";
	setAttr ".c2" -type "float3" 0.14399999 0.56401062 1 ;
...
connectAttr "nParticleShape1.inmr" "nParticleShape1.mas";
...
connectAttr "nComponent5.ocp" "dynamicConstraintShape4.cid[1]";
...
connectAttr "nucleus1_gravity.o" "nucleus1.grty";
...
connectAttr "nParticleShape1.nuid" "nComponent2.obid";
connectAttr "nRigidShape1.nuid" "nComponent4.obid";
connectAttr "nParticleShape1.nuid" "nComponent5.obid";
