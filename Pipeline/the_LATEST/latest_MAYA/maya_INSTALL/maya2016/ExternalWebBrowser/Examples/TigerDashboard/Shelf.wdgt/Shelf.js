...
function doNurbs(area)
{
	var command;
	switch(area) {
		case 1: command = "sphere"; break;
		case 2: command = "nurbsCube"; break;
		case 3: command = "cylinder"; break;
		case 4: command = "cone"; break;
		case 5: command = "nurbsPlane"; break;
		case 6: command = "torus"; break;
	}
...
function doPolys(area)
{
	var command;
	switch(area) {
		case 1: command = "polySphere"; break;
		case 2: command = "polyCube"; break;
		case 3: command = "polyCylinder"; break;
		case 4: command = "polyCone"; break;
		case 5: command = "polyPlane"; break;
		case 6: command = "polyTorus"; break;
		case 7: command = "polyPyramid"; break;
		case 8: command = "polyPipe"; break;
	}
...
function doSubds(area)
{
	var command;
	switch(area) {
		case 1: command = "createSubdSphere"; break;
		case 2: command = "createSubdCube"; break;
		case 3: command = "createSubdCylinder"; break;
		case 4: command = "createSubdCone"; break;
		case 5: command = "createSubdPlane"; break;
		case 6: command = "createSubdTorus"; break;
	}
