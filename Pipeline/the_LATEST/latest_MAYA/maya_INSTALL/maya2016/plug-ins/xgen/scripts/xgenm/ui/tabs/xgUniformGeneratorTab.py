...
class UniformGeneratorTabUI(GeneratorTabUI):
    def __init__(self):
        GeneratorTabUI.__init__(self,'Uniform',maya.stringTable[ 'y_xgUniformGeneratorTab.kUniform'  ])
        # Widgets
        self.baseTopUI()
        self.spacing = FloatUI("spacing",
             maya.stringTable[ 'y_xgUniformGeneratorTab.kSpacingAnn'  ],
             "UniformGenerator",0.01,1000000,0.01,0.5,maya.stringTable[ 'y_xgUniformGeneratorTab.kSpacing'  ])
